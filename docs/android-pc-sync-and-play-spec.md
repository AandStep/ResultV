...
| 3 | Три решения из редизайна ПК | **закрыт** 2026-09-07, запись в 3.4 |
...
прежние списки. Свежее состояние показывает выбранным «Smart (Antizapret)».
...
| Свежее состояние | в «Правилах» выбран «Smart (Antizapret)», список «в ВПН» пуст |
